        ...
        <div class="card p-4 p-lg-5">
            <div class="mb-5">
                <div class="d-flex align-items-center mb-4">
                    ...
                    <div>
                        <h2 class="text-xl fw-semibold text-dark mb-1">Editar Tipo de Veículo</h2>
                        <p class="small text-muted mb-0">Atualize os dados do tipo de veículo</p>
                    </div>
                </div>
            ...
            <!-- Form -->
            <form id="vehicleTypesForm" method="POST" action="{{ route('vehicle_types.update', $vehicleType->id) }}" data-loading-text="Atualizando...">
                @csrf
                @method('PUT')
                ...
                <div class="row g-4 mb-5">
                    ...
                    <div class="col-lg-6">
                        ...
                        <input id="txtNomeVeiculo" name="nomeVeiculo" required class="form-control" value="{{ old('nomeVeiculo', $vehicleType->nomeVeiculo) }}">
                    ...
                    <div class="col-lg-6">
                        ...
                        <input type="text" id="txtTipoVeiculo" name="tipoVeiculo" class="form-control" 
                               value="{{ old('tipoVeiculo', $vehicleType->tipoVeiculo) }}" placeholder="Ex: Caminhão, Carreta, Van">
                ...
                <div class="row g-4 mb-5">
                    ...
                    <div class="col-lg-3">
                        ...
                        <input type="number" id="txtQtdeEixo" name="qtdeEixo" required class="form-control" 
                               value="{{ old('qtdeEixo', $vehicleType->qtdeEixo) }}" min="0" max="10">
                    ...
                    <div class="col-lg-3">
                        ...
                        <input type="number" id="txtPesoLiquido" name="pesoLiquido" required class="form-control" 
                               value="{{ old('pesoLiquido', $vehicleType->pesoLiquido) }}" step="0.01" min="0">
                    ...
                    <div class="col-lg-3">
                        ...
                        <input type="number" id="txtPesoBruto" name="pesoBruto" required class="form-control" 
                               value="{{ old('pesoBruto', $vehicleType->pesoBruto) }}" step="0.01" min="0">
                ...
                <div class="row g-4 mb-5">
                    ...
                    <div class="col-lg-4">
                        ...
                        <input type="number" id="txtComprimento" name="comprimento" class="form-control" 
                               value="{{ old('comprimento', $vehicleType->comprimento) }}" step="0.01" min="0" placeholder="0.00">
                    ...
                    <div class="col-lg-4">
                        ...
                        <input type="number" id="txtAltura" name="altura" class="form-control" 
                               value="{{ old('altura', $vehicleType->altura) }}" step="0.01" min="0" placeholder="0.00">
                    ...
                    <div class="col-lg-4">
                        ...
                        <input type="number" id="txtLargura" name="largura" class="form-control" 
                               value="{{ old('largura', $vehicleType->largura) }}" step="0.01" min="0" placeholder="0.00">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" role="switch" id="switchAtivo" 
                                   name="ativo" value="1" {{ old('ativo', $vehicleType->ativo) ? 'checked' : '' }}>
...
<script src="{{ asset('assets/js/vehicle_types/edit_vehicle_types.js') }}" defer></script>
