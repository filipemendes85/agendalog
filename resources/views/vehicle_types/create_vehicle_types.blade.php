    ...
    <div class="container-fluid">
        <div id="groupsContent" class="content-section">
            <div class="d-flex align-items-center justify-content-between mb-6">
                <div>
                    <h2><a href="{{ route('vehicle_types.index') }}" class="text-xl font-semibold text-text-primary">Tipo de Veículos</a></h2>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    <form method="GET" action="{{ url('/vehicle_types') }}">
                        ...
                        <div class="row">
                            <div class="col">
                                <label class="block text-sm font-medium text-text-primary mb-1">Veículo</label>
            ...
            <div class="card p-6">
                <div class="d-flex justify-content-end align-items-center mb-4">
                    <span class="badge bg-primary">{{ $vehicle_types->total() }} clientes encontrados</span>
                </div>
                ...
                <div class="overflow-x-auto">
                    <table class="table w-full">
                        ...
                        <tbody class="divide-y divide-border" id="operationsTableBody">
                            @forelse($vehicle_types as $client)
                            <tr class="hover:bg-gray-50 transition-standard">
                                ...
                                <td class="py-2 px-2">
                                    <div class="flex items-center space-x-2">
                                        <!-- Ver Detalhes -->
                                        <a href="{{ route('vehicle_types.show', $client->id) }}" class="btn btn-outline-info btn-sm" title="Ver detalhes">
                                            <i class="ti ti-eye"></i>
                                        </a>
                                        
                                        <!-- Editar -->
                                        <a href="{{ route('vehicle_types.edit', $client->id) }}" class="btn btn-outline-primary btn-sm" title="Editar">
                                            <i class="ti ti-edit"></i>
                                        </a>
                                        
                                        <!-- Excluir -->
                                        <form id="delete-form-{{ $client->id }}" action="{{ route('vehicle_types.destroy', $client->id) }}" method="POST" class="d-inline" data-loading-text="Excluindo...">
                                            @csrf
                                            @method('DELETE')
