            ...
            <div class="mb-5">
                <div class="d-flex align-items-center justify-content-between mb-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h2 class="text-xl fw-semibold text-dark mb-1">Detalhes do Cliente</h2>
                            <p class="small text-muted mb-0">Informações completas do cliente</p>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <p class="form-control-plaintext">{{ $client->tipoPessoa == 'F' ? 'Pessoa Física' : 'Pessoa Jurídica' }}</p>
                            </div>
                            <div class="mb-3">
                                <label class="form-label fw-medium text-muted">CPF/CNPJ</label>
                                <p class="form-control-plaintext">{{ format_document($client->documento) }}</p>
                            </div>
                            <div class="mb-3">
                                <label class="form-label fw-medium text-muted">Status</label>
                                <p>
                                    <span class="badge {{ $client->ativo ? 'bg-success' : 'bg-danger' }}">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <p class="form-control-plaintext">{{ format_phone($client->telefone) }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <p class="form-control-plaintext">{{ $client->cep }}</p>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label fw-medium text-muted">Endereço</label>
                                        <p class="form-control-plaintext">{{ $client->endereco }}</p>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label class="form-label fw-medium text-muted">Número</label>
                                        <p class="form-control-plaintext">{{ $client->numero }}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <p class="form-control-plaintext">{{ $client->complemento ?? 'N/A' }}</p>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label class="form-label fw-medium text-muted">Bairro</label>
                                        <p class="form-control-plaintext">{{ $client->bairro }}</p>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label class="form-label fw-medium text-muted">Cidade</label>
                                        <p class="form-control-plaintext">{{ $client->cidade }}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
