                ...
                <div class="row g-4 mb-5">
                    ...
                    <div class="col-lg-3">
                        ...
                        <select class="form-select" name="tipoPessoa" id="tipoPessoa" required>
                            <option value="F" {{ old('tipoPessoa', $client->tipoPessoa) == 'F' ? 'selected' : '' }}>Pessoa Física</option>
                            <option value="J" {{ old('tipoPessoa', $client->tipoPessoa) == 'J' ? 'selected' : '' }}>Pessoa Jurídica</option>
                        </select>
                    ...
                    <div class="col-lg-3">
                        ...
                        <input type="text" id="txtDocumento" name="documento" required class="form-control" 
                               value="{{ old('documento', $client->documento) }}">
